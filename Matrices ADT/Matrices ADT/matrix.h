...
public:
	...
	//
	//void  operator= (const Matrix<T> & ref);
	//Matrix getTranspose();
	//Matrix operator+(const Matrix<T> & ref);
	//Matrix operator-(const Matrix<T> & ref);
	//Matrix operator*(const Matrix<T> &ref);
	//friend ostream& operator <<(ostream& str, const Matrix<T> &ref);
	//friend istream& operator >>(istream& istr, const Matrix<T>& ref);
